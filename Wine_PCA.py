...
# As OneHotEncoder was not used, we do require the "Avoiding the dummy variable" trap
...
# Applying the PCA: We first set n_components = None to get a descending list of the variance of each 
# independent variable in descending order. We then set n_components = 2 as we are selecting the top 
# two variables that account for 0.37 + 0.19 = 0.56 of the variance.
